                    ...
                    <div className={styles.containerInput}>
                        ...
                        <div className={styles.danger}>
                            {errores.currentStock && (
                                <span>{errores.currentStock}</span>
                            )}
                        </div>
                    </div>
                    ...
                    <div className={styles.containerInput}>
                        ...
                        <div className={styles.danger}>
                            {errores.publishedDate && (
                                <span>{errores.publishedDate}</span>
                            )}
                        </div>
                    </div>
